...
def main(page: ft.Page):
    ...
    def enviar_formulario(i):
        ...
        lista.controls.append(criar_item(nome))  # põe o item com contador na lista
    ...
    page.add(
        ft.Column(
            controls=[
                ft.Text("Mercado do mago", size=18, weight=ft.FontWeight.BOLD),
                ft.Column(
                    controls=[t_nome],
                    width=220,
                    spacing=2,
